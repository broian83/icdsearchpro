  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-[#00B4A4]">
        ...
        <p className="font-medium text-slate-500">Memuat data profil...</p>
      </div>
    );
  }
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">Lengkapi data diri Anda untuk pengalaman yang lebih baik.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="p-6 sm:p-8">
          <div className="flex items-center gap-4 mb-8 pb-8 border-b border-slate-100">
            <div className="w-20 h-20 rounded-full overflow-hidden bg-slate-100 shrink-0 border-4 border-slate-50 flex items-center justify-center shadow-sm">
            ...
            <div>
              <p className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-1">Email Terdaftar</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:border-[#00B4A4] focus:ring-4 focus:ring-[#00B4A4]/20 transition-all text-slate-800"
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1.5">Pekerjaan / Profesi</label>
              <input
                type="text"
                name="profession"
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1.5">Institusi / Rumah Sakit</label>
              <input
                type="text"
                name="institution"
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1.5">Spesialisasi / Minat Klinis</label>
              <input
                type="text"
                name="specialization"
